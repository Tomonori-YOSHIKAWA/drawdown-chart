...
| カテゴリ | 銘柄 |
| --- | --- |
| 株価指数 | 全世界株 (ACWI) / S&P 500 / NASDAQ 100 / NY ダウ / 日経平均株価 / TOPIX |
| 高配当・増配 ETF | SCHD / VYM / VIG |
| 債券 | AGG / TLT / 世界国債 (WGBI) |
| コモディティ | 金 (GLD) |

TOPIX・ACWI・WGBI は指数そのものを取得できないため連動 ETF で代替しています。見たいものは指数なので、TOPIX と ACWI は株価指数に分類しています。

WGBI の代替に使っている 2511（除く日本・為替ヘッジなし）は円建てのため、ドローダウンには債券価格だけでなく為替も含まれます。データも 2017-12 開始で、他銘柄の 10 年より短くなります。
